      ...
      <section>
        <div class="team">
          ...
          <div class="team_member">
            <div class="team_card">
              <div class="team_card_img"><img class="lazyload" data-src="./img/thahirudin.jpg" alt="Angga"></div>
              <div class="team_card_name"><h2>Angga Cahyo krisnanto</h2></div>
            </div>
            <div class="team_card">
              <div class="team_card_img"><img class="lazyload" data-src="./img/thahirudin.jpg" alt="Farhan"></div>
              <div class="team_card_name"><h2>Farhan Putra Bunga Mayang</h2></div>
            </div>
            <div class="team_card">
              <div class="team_card_img"><img class="lazyload" data-src="./img/thahirudin.jpg" alt="Thahirudin"></div>
